...
// Assignmet 4 code - not-not component
...
Blockly.LANG_LISTS_PICK_ITEM_FIRST_TOOLTIP = 'Pick the first item from the list.';
Blockly.LANG_LISTS_PICK_ITEM_LAST_TOOLTIP = 'Pick the last item from the list.';
